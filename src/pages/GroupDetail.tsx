...
import { Send, Paperclip, Trash2, ArrowLeft, ExternalLink, Phone, Calendar, Pencil, History, MoreVertical } from "lucide-react"; // ExternalLink is no longer needed for sending
...
const GroupDetailPage: React.FC = () => {
  ...
  const handleMessageSent = () => {
    // Refresh the group state in this dialog
    refresh();
  };
